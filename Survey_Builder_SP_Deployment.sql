/*
    ...
    Stored Procedure Update: Deploy Survey Builder Operations
    
    Instructions:
    1. Append these operation blocks to your main APIVisitOperation (or APIVisitHeaderOperation) stored procedure.
*/
